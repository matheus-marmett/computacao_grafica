...
Animais3D -> Cria uma cena 3D com múltiplos animais carregados via OBJ, distribuídos pelo cenário, e permite interatividade através de GUI para apontar a câmera para qualquer animal selecionado. Inclui controle de escala e rotação Y para o animal ativo, além de movimentação da câmera com o mouse.
